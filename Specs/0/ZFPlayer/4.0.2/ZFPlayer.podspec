...
Pod::Spec.new do |s|
    ...
    s.source           = { :git => 'http://gitlab.yonghuivip.com/ios/zfplayer', :tag => s.version.to_s }
    ...
    s.subspec 'SafeAreFix' do |safeareFix|
        safeareFix.source_files = 'ZFPlayer/Classes/SafeAreFix/*.{h,m}'
        safeareFix.public_header_files = 'ZFPlayer/Classes/SafeAreFix/*.h'
        safeareFix.dependency 'ZFPlayer/Core'
    end
